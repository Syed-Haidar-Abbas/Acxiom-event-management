...
// $review_str = "select review_content, review_id, review_rating, product_name, product_id from reviews join product on reviews.review_product_id=product.product_id where reviews.review_user_id=" . $user_id;
